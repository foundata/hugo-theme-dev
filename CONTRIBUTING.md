...
If you spot a problem, have an idea or a feature request, [search if an issue already exists](https://github.com/foundata/hugo-theme-dev/issues). If a related issue doesn't exist, you can simply open a new issue.
